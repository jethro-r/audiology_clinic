          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {contactInfo.map((item) => (
                    <div
                      key={item.title}
                      className="flex items-start gap-4 p-4 bg-[var(--card)] rounded-lg"
                    >
                      ...
                      <div>
                        ...
                        {item.link ? (
                          <a
                            href={item.link}
                            className="text-[var(--muted)] hover:text-[var(--primary)] transition-colors whitespace-pre-line"
                          >
                            {item.content}
                          </a>
                        ) : (
                          <p className="text-[var(--muted)] whitespace-pre-line">
                            {item.content}
                          </p>
                        )}
                      </div>
              ...
              <div>
                ...
                <div className="aspect-[16/9] bg-[var(--card)] rounded-xl overflow-hidden">
                  {/* Google Maps embed placeholder */}
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[var(--primary)]/10 to-[var(--primary-light)]/10">
                    <div className="text-center">
                      <MapPin className="h-12 w-12 text-[var(--primary)]/50 mx-auto mb-2" />
